  ...
  return (
    <AccordionPrimitive.Header className="flex">
      <AccordionPrimitive.Trigger
        ...
        className={cn(
          // cursor-pointer is explicit: Tailwind v4's preflight leaves <button> on the UA default
          // arrow, so every accordion header - including the mobile nav's parent items - read as
          // unclickable text without it.
