        ...
        <>
            ...
            <div className="bg-so-bg min-h-screen text-so-ink">
                ...
                <section className="dark relative isolate overflow-hidden bg-[#120a0d]">
                    ...
                    {/* The header band is a mount animation, not a scroll reveal - it is above the
                        fold on arrival, and `template.tsx` remounts it on every navigation, so
                        arriving here from the blog index reads as one continuous entrance. */}
                    <div className="relative z-10 max-w-[64rem] mx-auto pt-[calc(72px+3rem)] pb-14 px-6">
                        {/* Breadcrumb */}
                        <Entrance delay={0} distance={12}>
                ...
                <main className="max-w-[64rem] mx-auto px-6 pb-20 pt-12">
                    ...
                    {/* FAQ - the same component the landing page renders, with this post's items and
                        its own left-hand heading. The CTA pair is suppressed because the article's
                        own call to action sits immediately below it. Schema is off because the page
                        already emits FAQPage JSON-LD above. */}
                    {
                        faqs.length > 0 && (
                            <PageFAQ
                                items={faqs}
                                ...
                                withSchema={false}
                                showCta={false}
                                containerClassName="pt-16 md:pt-20"
                                eyebrow="Article FAQ"
                                title="Questions,"
                                titleAccent="answered"
                                description={`More on ${meta.title} - the follow-ups we get asked most, answered the way we would answer them on a call.`}
                            />
                        )
                    }
                    ...
                    <Reveal className="mt-16">
                        <div className="p-7 rounded-2xl bg-so-surface border border-so-line">
